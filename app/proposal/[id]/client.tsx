...
export default function ClientProposalView({ initialProposal }: ClientProposalViewProps) {
          ...
          <Card className="mt-8 border-green-200 bg-green-50">
            <CardHeader>
              ...
              <CardDescription className="text-green-700">
                This proposal has been accepted. Thank you for choosing our services!
              </CardDescription>
            </CardHeader>
            <CardContent>
              <p className="text-sm text-green-700">
                Next steps: Our team will reach out to you within 24 hours to discuss project kickoff and timeline.
              </p>
            </CardContent>
          </Card>
        )}
